...
import com.thesischecker.validators.IdModelValidator;
...
public class ResourcesController {
    ...
    @RequestMapping(value = "/getById", method = RequestMethod.POST,
            ...
            consumes = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public ResponseUtil get(@RequestBody IdModel idModel,
                            BindingResult result)
    {
    ...
    public ResponseUtil upload(MultipartHttpServletRequest request,
        ...
        return new ResponseUtil("Unexpected error. File can't be uploaded", new ArrayList());
    }
