...
public class FileProcessTest extends TestCase {
    ...
    public void testGetFileFromDisk() throws Exception {
        //FileProcess fileP = new FileProcess(currentDir+"/WebApplication/app-java/src/main/resources/files/test584778542838682843.md");
    ...
    public void testCreateTempFile() throws Exception {
        //FileProcess fileP = new FileProcess(currentDir+"/WebApplication/app-java/src/main/resources/files");
        //File uploadFile = new File(currentDir+"/WebApplication/app-java/src/test/resources/testow.towy.md");
