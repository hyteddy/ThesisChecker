...
<body>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/admin_form.js"></script>

	<div id="content">
		<div id="logoz">
			<div id="logow"><img src="${pageContext.request.contextPath}/resources/images/nazwa.png" class="img-circle"></div>
		</div>
		<div id="identification"><p class="text-info"><shiro:principal/></p></div>
